...
class CreateMonitoringRequestEvent extends AbstractMigration {
    static $eventData = [
        'EVENT_NAME' => 'NEW_SERVICE_REQUEST_MONITORING',
        'EVENT_TITLE' => 'Новая заявка на проведение мониторинга',
        'MESSAGE_TITLE' => '#SITE_NAME#: Новая заявка на проведение мониторинга',
        'FIELDS' => [
            'NAME' => 'Наименование объекта(ов) мониторинга',
            'LOCATION' => 'Местонахождение объекта(ов)',
            'MONITORING_GOAL' => 'Каковы цели проведения мониторинга',
            'DESCRIPTION' => 'Описание объекта(ов) мониторинга (назначение, этажность, наличие подвала, площадь, год постройки и пр.)',
            'ADDITIONAL_INFO' => 'Дополнительная информация по мониторингу',
