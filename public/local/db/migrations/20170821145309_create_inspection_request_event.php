...
class CreateInspectionRequestEvent extends AbstractMigration {
    static $eventData = [
        'EVENT_NAME' => 'NEW_SERVICE_REQUEST_INSPECTION',
        'EVENT_TITLE' => 'Новая заявка на проведение обследования',
        'MESSAGE_TITLE' => '#SITE_NAME#: Новая заявка на проведение обследования',
        'FIELDS' => [
            'NAME' => 'Наименование объекта(ов) обследования',
            'LOCATION' => 'Местонахождение объекта(ов)',
            'INSPECTION_GOAL' => 'Опишите цели обследования',
            'DESCRIPTION' => 'Описание объекта(ов) обследования',
            'ADDITIONAL_INFO' => 'Дополнительная информация по обследованию',
