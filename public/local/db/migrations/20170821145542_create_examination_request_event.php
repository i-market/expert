...
class CreateExaminationRequestEvent extends AbstractMigration {
    static $eventData = [
        'EVENT_NAME' => 'NEW_SERVICE_REQUEST_EXAMINATION',
        'EVENT_TITLE' => 'Новая заявка на проведение экспертизы',
        'MESSAGE_TITLE' => '#SITE_NAME#: Новая заявка на проведение экспертизы',
        'FIELDS' => [
            'NAME' => 'Наименование объекта(ов) экспертизы',
            'LOCATION' => 'Местонахождение объекта(ов)',
            'EXAMINATION_GOAL' => 'Опишите цели проведения экспертизы',
            'DESCRIPTION' => 'Описание объекта(ов) экспертизы',
            'ADDITIONAL_INFO' => 'Дополнительная информация по экспертизе',
