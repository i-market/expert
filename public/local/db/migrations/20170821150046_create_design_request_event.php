...
class CreateDesignRequestEvent extends AbstractMigration {
    static $eventData = [
        'EVENT_NAME' => 'NEW_SERVICE_REQUEST_DESIGN',
        'EVENT_TITLE' => 'Новая заявка на разработку проектных решений',
        'MESSAGE_TITLE' => '#SITE_NAME#: Новая заявка на разработку проектных решений',
        'FIELDS' => [
            'NAME' => 'Наименование объекта(ов)',
            'LOCATION' => 'Местонахождение объекта(ов)',
            'ADDITIONAL_INFO' => 'Дополнительная информация по обследованию',
            'ITEMS' => 'Какие проектные решения необходимо разработать',
