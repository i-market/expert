...
class CreateInspectionRequestsIblock extends AbstractMigration {
    static $iBlockData = [
        'NAME' => 'Заявки на проведение обследования',
        'CODE' => 'inspection_requests',
        'TYPE' => 'inbox',
    ];
    ...
    function up() {
        ...
        try {
            ...
            $propSpecs = [
                ...
                [
                    'CODE' => 'INSPECTION_GOAL',
                    'NAME' => 'Опишите цели обследования',
                    'USER_TYPE' => 'HTML',
                ],
                [
                    'CODE' => 'DESCRIPTION',
                    'NAME' => 'Описание объекта(ов) обследования',
                    'USER_TYPE' => 'HTML',
                ],
                [
