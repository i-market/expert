...
class CreateExaminationRequestsIblock extends AbstractMigration {
    static $iBlockData = [
        'NAME' => 'Заявки на проведение экспертизы',
        'CODE' => 'examination_requests',
        'TYPE' => 'inbox',
    ];
    ...
    function up() {
        ...
        try {
            ...
            $propSpecs = [
                ...
                [
                    'CODE' => 'EXAMINATION_GOAL',
                    'NAME' => 'Опишите цели проведения экспертизы',
                    'USER_TYPE' => 'HTML',
                ],
                [
                    'CODE' => 'DESCRIPTION',
                    'NAME' => 'Описание объекта(ов) экспертизы',
                    'USER_TYPE' => 'HTML',
                ],
                [
                    'CODE' => 'ADDITIONAL_INFO',
                    'NAME' => 'Дополнительная информация по экспертизе',
                    'USER_TYPE' => 'HTML',
                ],
                [
                    'CODE' => 'DOCUMENTS',
