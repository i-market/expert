...
class CreateOversightRequestsIblock extends AbstractMigration {
    static $iBlockData = [
        'NAME' => 'Заявки на проведение технического надзора, строительного контроля',
        'CODE' => 'oversight_requests',
        'TYPE' => 'inbox',
    ];
    ...
    function up() {
        ...
        try {
            ...
            $propSpecs = [
                ...
                [
                    'CODE' => 'DESCRIPTION',
                    'NAME' => 'Описание объекта(ов) технического надзора'
                ],
                [
                    'CODE' => 'DOCUMENTS',
