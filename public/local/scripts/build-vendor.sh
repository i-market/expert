cp node_modules/blueimp-file-upload/js/{jquery.fileupload.js,jquery.fileupload-process.js,jquery.fileupload-validate.js,jquery.iframe-transport.js,vendor/jquery.ui.widget.js} ${npm_package_config_dist}/js/vendor &&
