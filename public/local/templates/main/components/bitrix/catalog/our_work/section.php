...
?>
<?
// TODO refactor: proper flow control (render either `section.list` or `section`)
// based on whether or not current section is a leaf section?
?>
...
if (count($APPLICATION->arAdditionalChain) > 2) {
    // but first and last
