<div id="global-error-message" style="display: none">
    ...
    <? if ($sentry['enabled']): ?>
        Мы отправили письмо разработчикам с информацией о том, что произошло.
    <? elseif ($adminEmailMaybe !== null): ?>
        Пожалуйста, <a href="<?= "mailto:{$adminEmailMaybe}" ?>">напишите нам письмо</a> с описанием того, что вы пытались сделать, когда произошла ошибка.
    <? endif ?>
