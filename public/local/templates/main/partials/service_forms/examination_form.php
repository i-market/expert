...
<div class="wrap_input_block">
    <? $macros->showInput('NAME', 'Наименование объекта(ов) экспертизы', ['required' => true]) ?>
    <? $macros->showInput('LOCATION', 'Местонахождение объекта(ов)') ?>
    <? $macros->showTextarea('EXAMINATION_GOAL', 'Опишите цели проведения экспертизы', ['required' => true]) ?>
    <? $macros->showTextarea('DESCRIPTION', 'Описание объекта(ов) экспертизы (назначение, этажность, наличие подвала, площадь, год постройки и пр.)',
        ['required' => true]) ?>
